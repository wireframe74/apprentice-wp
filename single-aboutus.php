...
echo'<div id="aigwd-maincontentcontainer" class="row">';
  ...
  echo'<div class="postCollapse aboutus">';
            // the_loop begin
...
echo '</ul>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   			if ( get_post_meta($post->ID, 'sh_anchor1', true) )   
			echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor2', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor3', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor4', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor5', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor6', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor7', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor8', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor9', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor10', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor11', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		echo do_shortcode (get_post_meta($post->ID, 'sh_anchor10', true));
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor12', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor13', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor14', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor15', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor16', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor17', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor18', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
 ...
 //set anchor id   	
		...
		// set the scrollable area content
   		if ( get_post_meta($post->ID, 'sh_anchor19', true) )   echo'</div><div class="backtotopscroll"><a href="#top"><span class="wpjb-glyphs wpjb-icon-right-open"></span> back to top</a></div>';
