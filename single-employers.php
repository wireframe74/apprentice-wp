<?php
/**
 * THIS IS THE SINGLE EMPLOYERS TEMPLATE USED TO DISPLAY ALL SINGLE EMPLOYER PAGES
   APART FROM:
   'INFO ON APPRENTICESHIPS' WHICH USES SINGLE-EMPLOYERS-TABS.PHP & /PAGE-FURNITURE/TABS.PHP
