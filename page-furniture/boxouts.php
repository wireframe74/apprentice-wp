...
<div class="row">
        ...
        <div class="full-width-sm col-xs-6">
            <div class="icon-widget icon-widget__lg icon-widget__orange icon-widget__rev">
                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/icons/apprentice.svg" alt="Apprentice">
                <h3>Apprentices</h3>
                <p>Helping you achieve your ambitions</p>
                <div class="clearfix"></div>
                <a class="aig-btn aig-btn__reversed hero--btn"  href="#" role="button">Discover More</a>
            </div>
        </div>
...
<div class="section clearfix">
        ...
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/icons/quick_link_1.svg" alt="Employers">  
        <h4>Looking for an Apprentice?</h4>
        <p>Rigorous selection and management processes designed to ensure you get a return.</p>
        <a class="aig-btn aig-btn__small"  href="#" role="button">Discover More</a>
        </div>
        </div>
        ...
        <div class="col-xs-6 col-sm-3">
        <div class="icon-widget icon-widget__sm">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/icons/quick_link_2.svg" alt="Employers">  
        ...
        <div class="col-xs-6 col-sm-3">
        <div class="icon-widget icon-widget__sm">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/icons/quick_link_3.svg" alt="Employers">  
        ...
        <div class="col-xs-6 col-sm-3">
        <div class="icon-widget icon-widget__sm">
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/icons/quick_link_4.svg" alt="Employers">  
