...
<div class="row">
        ...
        <div class="full-width-sm col-xs-6 wow fadeInUp">
            <div class="icon-widget icon-widget__lg icon-widget__orange icon-widget__rev">
                ...
                <h3>Apprentices</h3>
                <p>Helping you achieve your ambitions</p>
                <div class="clearfix"></div>
                <a class="aig-btn aig-btn__reversed hero--btn"  href="<?php bloginfo('url'); ?>/apprentices/apprentices/" role="button">Discover More</a>
            </div>
        </div>
        ...
        <div class="full-width-sm col-xs-6 wow fadeInUp" data-wow-delay=".3s">
            ...
            <p>Helping you achieve your ambitions</p>
            <div class="clearfix"></div>
            <a class="aig-btn aig-btn__reversed hero--btn"  href="<?php bloginfo('url'); ?>/employers/employers/" role="button">Discover More</a>
            </div>
        </div>
...
<div class="section clearfix">
        ...
        <a class="aig-btn aig-btn__small"  href="<?php bloginfo('url'); ?>/employers/employers/" role="button">Discover More</a>
        </div>
        </div>
        ...
        <a class="aig-btn aig-btn__small"  href="<?php bloginfo('url'); ?>/aigwd-apprentices/tool-kit/" role="button">Discover More</a>
        </div>
        </div>
        ...
        <a class="aig-btn aig-btn__small"  href="<?php bloginfo('url'); ?>/employers/how-we-can-help-your-business/" role="button">Discover More</a>
        </div>
        </div>
        ...
        <a class="aig-btn aig-btn__small"  href="http://www.aigroup.com.au/" target="_blank" role="button">Discover More</a>
        </div>
        </div>
